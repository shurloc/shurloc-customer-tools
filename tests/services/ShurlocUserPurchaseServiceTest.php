 ...
 */
final class ShurlocUserPurchaseServiceTest extends TestCase {
	 ...
	 */
	private Shurloc_User_Purchase_Service $service;
	...
	protected function setUp(): void {
		...
		$this->service = new Shurloc_User_Purchase_Service();
	}
