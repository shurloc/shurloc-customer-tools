 ...
 */
final class ShurlocUserActivityServiceTest extends TestCase {

	/**
	 * Service under test.
	 *
	 * @var Shurloc_User_Activity_Service
	 */
	private Shurloc_User_Activity_Service $service;
	...
	protected function setUp(): void {
		...
		$this->service = new Shurloc_User_Activity_Service();
	}
