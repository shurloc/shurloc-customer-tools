 ...
 */
final class ShurlocUserColumnsTest extends TestCase {

	/**
	 * User columns class under test.
	 *
	 * @var Shurloc_User_Columns
	 */
	private Shurloc_User_Columns $user_columns;
	...
	protected function setUp(): void {
		...
		$this->user_columns = new Shurloc_User_Columns();
	}
	...
	public function test_unrelated_columns_are_preserved(): void {
		...
		$result = $this->user_columns->remove_unused_columns( $columns );
	...
	public function test_missing_jetpack_column_is_ignored(): void {
		...
		self::assertSame(
			$columns,
			$this->user_columns->remove_unused_columns( $columns )
		);
	}
}
