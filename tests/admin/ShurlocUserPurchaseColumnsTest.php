 ...
 */
final class ShurlocUserPurchaseColumnsTest extends TestCase {

	/**
	 * Columns class under test.
	 *
	 * @var Shurloc_User_Purchase_Columns
	 */
	private Shurloc_User_Purchase_Columns $columns;
	...
	protected function setUp(): void {
		...
		$this->columns = new Shurloc_User_Purchase_Columns(
	...
	public function test_missing_purchase_timestamp_renders_never(): void {
		...
		$result = $this->columns->render_column(
			'',
			Shurloc_User_Purchase_Columns::LAST_PURCHASE_COLUMN,
			101
		);
	...
	public function test_zero_purchase_timestamp_renders_never(): void {
		...
		$GLOBALS['shurloc_test_user_meta'][101]
			[ Shurloc_User_Purchase_Service::LAST_PURCHASE_META_KEY ] = 0;
	...
	public function test_last_purchase_column_is_sortable(): void {
		...
		self::assertSame(
			...
			$result[ Shurloc_User_Purchase_Columns::LAST_PURCHASE_COLUMN ]
		);
	}
