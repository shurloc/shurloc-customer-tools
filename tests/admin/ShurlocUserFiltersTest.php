 ...
 */
final class ShurlocUserFiltersTest extends TestCase {

	/**
	 * User filters coordinator under test.
	 *
	 * @var Shurloc_User_Filters
	 */
	private Shurloc_User_Filters $user_filters;
	...
	protected function setUp(): void {
		...
		$this->user_filters = new Shurloc_User_Filters();
	}
	...
	public function test_filters_are_rendered_at_top(): void {
		...
		$this->user_filters->render_filters( 'top' );
	...
	public function test_filters_are_not_rendered_at_bottom(): void {
		...
		$this->user_filters->render_filters( 'bottom' );
