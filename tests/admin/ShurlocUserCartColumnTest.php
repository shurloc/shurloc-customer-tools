 ...
 */
final class ShurlocUserCartColumnTest extends TestCase {

	/**
	 * Cart column under test.
	 *
	 * @var Shurloc_User_Cart_Column
	 */
	private Shurloc_User_Cart_Column $cart_column;
	...
	protected function setUp(): void {
		...
		$this->cart_column = new Shurloc_User_Cart_Column();
	}
	...
	public function test_cart_column_is_added(): void {
		...
		self::assertSame(
			'Cart',
			$result[ Shurloc_User_Cart_Column::CART_COLUMN ]
		);
	}
	...
	public function test_missing_cart_renders_em_dash(): void {
		...
		$result = $this->cart_column->render_column(
			'',
			Shurloc_User_Cart_Column::CART_COLUMN,
			101
		);
	...
	public function test_zero_item_count_renders_em_dash(): void {
		...
		$GLOBALS['shurloc_test_user_meta'][101]
			[ Shurloc_User_Cart_Service::CART_COUNT_META_KEY ] = 0;
	...
	public function test_assets_are_enqueued_on_users_screen(): void {
		...
		$this->cart_column->enqueue_assets( 'users.php' );
	...
	public function test_assets_are_not_enqueued_on_other_admin_screens(): void {
		...
		$this->cart_column->enqueue_assets( 'edit.php' );
	...
	private function seed_cart_meta(
		...
		$GLOBALS['shurloc_test_user_meta'][ $user_id ] = array(
			Shurloc_User_Cart_Service::CART_COUNT_META_KEY => $item_count,
			Shurloc_User_Cart_Service::CART_TOTAL_META_KEY => $total,
			Shurloc_User_Cart_Service::CART_ITEMS_META_KEY => $contents,
		);
	}
}
