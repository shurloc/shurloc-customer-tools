...
param(
    [string]$PluginName = "shurloc-customer-tools"
)
...
#
if (-not (Test-Path "$PluginRoot\shurloc-customer-tools.php")) {
    throw "Plugin bootstrap file 'shurloc-customer-tools.php' was not copied."
}
