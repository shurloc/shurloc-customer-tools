 ...
 */
final class Shurloc_User_Purchase_Columns {
	...
	private function render_purchase(
		...
		$time_text = $this->time_formatter->format( $timestamp );

		$status_text = $this->format_status( $status );

		$total_text = $this->format_total( $total );
