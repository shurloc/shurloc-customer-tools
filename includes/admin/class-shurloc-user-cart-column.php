 ...
 */
final class Shurloc_User_Cart_Column {
	...
	public function enqueue_assets(
		...
		wp_enqueue_style(
			self::ASSET_HANDLE,
			SHURLOC_CUSTOMER_TOOLS_URL . 'assets/css/user-cart-column.css',
			array(),
		...
		wp_enqueue_script(
			self::ASSET_HANDLE,
			SHURLOC_CUSTOMER_TOOLS_URL . 'assets/js/user-cart-column.js',
			array(),
			SHURLOC_CUSTOMER_TOOLS_VERSION,
			true
		);
			...
			>
				...
				<div class="shurloc-cart-panel-header">
					...
					<a
						...
						aria-label="<?php echo esc_attr__( 'Close cart details', 'shurloc-customer-tools' ); ?>"
					>
						&times;
					</a>
	...
	private function render_cart_item(
		...
		$attributes = $this->get_variation_attributes_text( $item );
		?>
