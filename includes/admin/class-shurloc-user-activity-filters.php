 ...
 */
final class Shurloc_User_Activity_Filters {
...
-->
	...
	private function apply_sorting(
		...
		if (
			Shurloc_User_Activity_Service::LAST_LOGIN_META_KEY !== $orderby &&
			Shurloc_User_Activity_Service::LAST_ACTIVITY_META_KEY !== $orderby
		) {
			return;
		}
	...
	private function get_request_filter(
		...
		// phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Read-only Users screen filter.
		$request_value = wp_unslash( $_GET[ $request_key ] );
